...
namespace Selenium3
{
    class Runner_UAT
    {
        ...
        public static void REOFlowOrg2(Driver driver)
        {
            ...
            Login.Agent(driver, ENV.UAT, "QATest23@usres.com", "blue123");
            ...
            // List the Property
            SeleniumWindowMethods.Sleep(2);
            Login.REO(driver, ENV.UAT, "sdqaam15", "P@ssw0rd2");  // QA login 
            ...
            Login.Agent(driver, ENV.UAT, "QATest23@usres.com", "blue123");     // QA Login 
            Portal_Agent.Agentsearch(driver, Global.PropertyID);
        ...
        public static void RAFlow1Org1(Driver driver, City city)
        {
            ...
            Form_Val_RentalAnalysis.Attachments(driver, ENV.UAT);
            Logout.Portal(driver, Portals.Agent);
            Login.ValPortal(driver, environment, valportalusername, valportalpassword);
        ...
        {
            Login.Agent(driver, ENV.UAT, "qa12270935@usres.com", "testing");
            Portal_Agent.ProAgent(driver);
        }

        public static void HomeownerDILFlow(Driver driver)
        {
            Login.Homeowner(driver, ENV.UAT, "AutoHome", "testing");
            Portal_Homeowner.CreateDILProperty(driver);
            Login.LossMit(Driver.driver1, ENV.UAT, "qaservicer", "P@ssw0rd1");
            ...
            Login.Vendor(driver, ENV.UAT, "qatitlevendor", "P@ssw0rd1");
        ...
        {
            AddNewUser.ProPlusAgent(driver, ENV.UAT, CreditCardType.MasterCard1);
        }
    }
}