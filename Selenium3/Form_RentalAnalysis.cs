    ...
    class Form_RentalAnalysis
    {
        ...
        public static void Attachments(Driver driver, ENV environment)
        {
            ...
            if (environment == ENV.QA)
            {
                ...
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "37_1_fileupload", Global.folderpath + "C1.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "38_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "38_1_fileupload", Global.folderpath + "C2.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "44_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "44_1_fileupload", Global.folderpath + "C3.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "45_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "45_1_fileupload", Global.folderpath + "C4.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "46_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "46_1_fileupload", Global.folderpath + "C5.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "47_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "47_1_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "48_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "48_1_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "49_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "49_1_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "97_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "97_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "productUpload_159_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "productUpload_159_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
            }
            else if (environment == ENV.UAT)
            {
                ...
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "15_1_fileupload", Global.folderpath + "C1.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "16_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "16_1_fileupload", Global.folderpath + "C2.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "22_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "22_1_fileupload", Global.folderpath + "C3.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "23_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "23_1_fileupload", Global.folderpath + "C4.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "24_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "24_1_fileupload", Global.folderpath + "C5.jpg");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "32_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "32_1_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "33_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "33_1_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "34_1_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "34_1_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.Clear(driver, ElementType.Id, "1543_fileupload");
                SeleniumWindowMethods.ThrottlingSleep();
                SeleniumSetMethods.EnterText(driver, ElementType.Id, "1543_fileupload", Global.folderpath + "AUpload.pdf");
                SeleniumWindowMethods.ThrottlingSleep();
