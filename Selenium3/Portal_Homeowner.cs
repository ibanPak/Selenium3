...
namespace Selenium3
{
    class Portal_Homeowner
    {
        ...
        public static void HODILHomeownerPartII(Driver driver)
        {
            ...
            SeleniumSetMethods.EnterText(driver, ElementType.Id, "FileFirst_Required_fileupload", Global.folderpath + "H5.jpg");
            SeleniumSetMethods.EnterText(driver, ElementType.Id, "FileSecond_Required_fileupload", Global.folderpath + "C5.jpg");
            SeleniumWindowMethods.Sleep(3);
            ...
            SeleniumSetMethods.EnterText(driver, ElementType.Id, "FileHardshipLetter_fileupload", Global.folderpath + "H5.jpg");
            SeleniumSetMethods.EnterText(driver, ElementType.Id, "FileTaxReturns_fileupload", Global.folderpath + "H5.jpg");
            SeleniumSetMethods.EnterText(driver, ElementType.Id, "FileBankStatements_fileupload", Global.folderpath + "C5.jpg");
            ...
            SeleniumSetMethods.EnterText(driver, ElementType.Id, "FileW2and1099_fileupload", Global.folderpath + "AUpload.pdf");
            SeleniumSetMethods.EnterText(driver, ElementType.Id, "FilePaycheckStubs_fileupload", Global.folderpath + "B5.jpg");
